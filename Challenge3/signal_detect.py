...
sub_signal = rospy.Subscriber('signalSignal', String, signal_callback)
...
if (sub_signal == "YELLOW"):
    signal_value = .5
elif (sub_signal == "GREEN" or sub_signal == "FORWARD"):
    signal_value = 1
elif(sub_signal == "RED" or sub_signal == "STOP"):
    signal_value = 0
