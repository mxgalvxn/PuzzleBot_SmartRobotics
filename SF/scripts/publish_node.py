...
class LineFollower():
    def __init__(self):
        ...
        vel = 0.08  # Velocidad lineal del robot
        ...
        while not rospy.is_shutdown():
            if self.image_received_flag:
                ...
                signal = rospy.get_param('/signals')
                print('SENAL: ', signal)
                ...
                if (signal == "YELLOW" or signal == "CONSTRUCTION" or signal == "GIVEWAY"):
                    ...
                    angular_z = -.4 # 90 degrees in radians (clockwise)
                    twist_msg.linear.x = vel
                    ...
                    angular_z = 1.57  # 90 degrees in radians (counter-clockwise)
                    twist_msg.linear.x = vel
                    twist_msg.angular.z = angular_z
                    #print(twist_msg)                        
                    self.robot_vel_pub.publish(twist_msg)
                ...
                self.linear_vel = vel * signal_value
